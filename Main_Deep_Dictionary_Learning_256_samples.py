...
step = 5             # Patches' step
ratio =0.8             # Ratio for the dictionary (training set).
...
loc_d = ('G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3a_deep_learning_for_parameter_estimation/programs/anamoly_detection_LSTM_RNN//tr_data_pert_april_2014_mls_256_samples.xlsx');#train data
...
loc_d = ('G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3a_deep_learning_for_parameter_estimation/programs/anamoly_detection_LSTM_RNN/tst_data_21_04_2014_256_samples.xlsx');#test data
wb = xlrd.open_workbook(loc_d)
sheet = wb.sheet_by_index(0)
sheet.cell_value(0, 0)
for k in range(1,sheet.ncols):#columns
