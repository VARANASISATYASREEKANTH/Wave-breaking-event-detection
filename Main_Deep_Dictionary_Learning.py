...
ratio =0.3             # Ratio for the dictionary (training set).
...
loc_d = ('G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3a_deep_learning_for_parameter_estimation/Aura_MLS/AURA_DATA_April_2014/tr_data_pert_april_2014_mls.xlsx');#train data
...
loc_d = ('G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3a_deep_learning_for_parameter_estimation/programs/anamoly_detection_LSTM_RNN/y_out_convLSTM_21_04_2014_256_samples.xlsx');#test data
wb = xlrd.open_workbook(loc_d)
sheet = wb.sheet_by_index(0)
sheet.cell_value(0, 0)
for k in range(1,sheet.ncols):#columns
