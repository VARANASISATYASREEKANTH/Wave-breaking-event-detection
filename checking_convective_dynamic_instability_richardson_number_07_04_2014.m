...
clear all; 
close all;
AA=xlsread('test_data_07_04_2014.xlsx');
%AA=AA1(1:184,1:61);
...
T_0_dash=mean(transpose(AA(1:184,1:15)));
...
%---dynamic instability---
y1 = interp(V_21_04_2014(2,1:9),6);
y2=interp(V_21_04_2014(1,1:9),6);
y=(y1-y2)/0.3;
%gradient_u=gradient(y,0.6);
%d1=size(N_square(1,95:128)); d2=size(square(gradient_u(1:34)));
R_i=(mean(N_square(95:128,:)))./(transpose(square(y(1:34))));
