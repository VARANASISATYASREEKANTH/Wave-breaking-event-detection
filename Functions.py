...
def k_svd(phi, matrix_y, sigma, algorithm, n_iter, approx='yes'):
    ...
    for k in xrange(n_iter):
        ...
        df.to_excel(excel_writer = "G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3a_deep_learning_for_parameter_estimation/Aura_MLS/AURA_DATA_April_2014/D_21_04_2014_64_samples.xlsx")
        df = pd.DataFrame(sparse_matrix_out);
        df.to_excel(excel_writer = "G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3a_deep_learning_for_parameter_estimation/Aura_MLS/AURA_DATA_April_2014/X_21_04_2014_64_samples.xlsx")
...
def denoising(noisy_image, learning_image, window_shape, window_step, sigma, learning_ratio=0.1, ksvd_iter=1):
    ...
    df.to_excel(excel_writer = "G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3_study_of_gravity_waves_with_rayleigh_lidar/working_programs/programs/ksvd_GW_analysis/denoised_temp_perturbations_21_04_2014.xlsx")
