...
loc1=('G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3a_deep_learning_for_parameter_estimation/programs/anamoly_detection_LSTM_RNN//tr_data_pert_april_2014_mls_64_samples.xlsx')
wb = xlrd.open_workbook(loc1)
sheet = wb.sheet_by_index(0)
T_pert=np.zeros((sheet.nrows,sheet.ncols));
for i in range(sheet.nrows):
...
loc1=('G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3a_deep_learning_for_parameter_estimation/Aura_MLS/AURA_DATA_April_2014/k_approx_21_04_2014_64_samples.xlsx')
wb = xlrd.open_workbook(loc1)
sheet = wb.sheet_by_index(0)
...
data =T_pert.reshape(1, 128, 64, 1)#training
data_test=test_data_pert.reshape(1, 128, 64,1)# reshaping test data


#---------------------CNN model----------------------
model=Sequential()
model.add(Conv2D(32, kernel_size=(16, 16),activation='linear',input_shape=(128,64,1),padding='same'))
