...
tst1_re2=resample(transpose(tst1_re),23,29);
final_tst1=transpose(tst1_re2);

%---tst2 data
d_tst2_pert=transpose(d_tst2-mean(d_tst2));
tst2_re=resample(d_tst2_pert,10,4);
tst2_re2=resample(transpose(tst2_re),23,29);
final_tst2=transpose(tst2_re2);

%---tst3 data
d_tst3_pert=transpose(d_tst3-mean(d_tst3));
tst3_re=resample(d_tst3_pert,10,4);
tst3_re2=resample(transpose(tst3_re),30,35);
final_tst3=transpose(tst3_re2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%Resampling Dictionary and Sparse matrix----------------------
[X,txt,raw]=xlsread('G:\research_works_vssreekanth_jrf\MY_PAPERS\paper_3a_deep_learning_for_parameter_estimation\Aura_MLS\AURA_DATA_April_2014\X_21_04_2014_256_samples.xlsx');
X_re1=resample(transpose(X),10,3);
X_re2=transpose(X_re1);
[D,txt,raw]=xlsread('G:\research_works_vssreekanth_jrf\MY_PAPERS\paper_3a_deep_learning_for_parameter_estimation\Aura_MLS\AURA_DATA_April_2014\D_21_04_2014_256_samples.xlsx');
D_re1=resample(transpose(D),5,4);
D_re2=transpose(D_re1);
...
[d,txt,raw]=xlsread('G:\research_works_vssreekanth_jrf\MY_PAPERS\paper_3a_deep_learning_for_parameter_estimation\Aura_MLS\AURA_DATA_April_2014\D_resampled_21_04_2014.xlsx');
[x,txt,raw]=xlsread('G:\research_works_vssreekanth_jrf\MY_PAPERS\paper_3a_deep_learning_for_parameter_estimation\Aura_MLS\AURA_DATA_April_2014\X_resampled_21_04_2014.xlsx');
y=d*x;
