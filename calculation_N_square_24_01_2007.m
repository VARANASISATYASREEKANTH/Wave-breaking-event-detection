...
clear all; 
close all;
AA=xlsread('test_data_24_01_2007_ver3.xlsx');
%AA=AA1(1:184,1:61);
...
T_0_dash=mean(transpose(AA(1:184,20:55)));
T_0=movmean(T_0_dash,10);
grad_temp =(gradient(T_0,0.3));
g_z=9.8.*(1-(2*ht)./r_e);
c_p=100.0035;


N_square=(4.*3.14.*3.14.*(g_z./T_0).*(grad_temp+100*(g_z./c_p)));
